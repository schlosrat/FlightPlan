...
namespace MuMech
{
    public class ComputerModule : IComparable<ComputerModule>
    {
        ...
        //conveniences:
        public VesselComponent        vessel   => part.PartOwner.SimulationObject.Vessel;        // Need to confirm
        public CelestialBodyComponent mainBody => part.PartOwner.SimulationObject.CelestialBody; // Need to confirm
        public PatchedConicsOrbit     orbit    => part.PartOwner.SimulationObject.Vessel.Orbit;  // Need to confirm
        ...
        public ComputerModule() // was: MechJebCore core
        {
            // this.core    = core;
            // part         = core.part;
        ...
        public virtual void OnVesselWasModified(VesselComponent v)
        {
        }

        public virtual void OnVesselStandardModification(VesselComponent v)
        {
        }

        public virtual void OnStart(PartModuleStartState state) //// was KSP1 Assembly-CSharp thing: PartModule.StartState
        {
        }
        ...
        public virtual void OnLoad() // was: ConfigNode ConfigNode local, ConfigNode type, ConfigNode global
        {
            //try
            //{
        ...
        public virtual void OnSave() // was: ConfigNode ConfigNode local, ConfigNode type, ConfigNode global
        {
            //try
            //{
            //    if (global != null)
