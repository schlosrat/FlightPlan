...
namespace MuMech
{
    ...
    {
        private static readonly string _name = "change inclination"; // Localizer.Format("#MechJeb_inclination_title");
        public override         string GetName() => _name;

        [UsedImplicitly]
        // [Persistent(pass = (int)Pass.GLOBAL)]
        // public EditableDouble NewInc = 0;
        private double NewInc;
        ...
        public override void DoParametersGUI(PatchedConicsOrbit o, double universalTime, CelestialBodyComponent target) // was: MechJebModuleTargetController target
        {
            ...
            NewInc = FpUiController.TargetInc_deg;
        }
