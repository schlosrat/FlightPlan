...
namespace MuMech
{
    public class TransferCalculator
    {
        ...
        private void AdjustPeriapsis(ManeuverParameters maneuver, ref double utArrival)
        {
            ...
            FlightPlanPlugin.Logger.LogInfo($"maneuver guess dV: {maneuver.dV:N3} = {maneuver.dV.magnitude:N3} m/s");
            ...
            double utArrival, double earliestUT, double targetPeR, bool includeCaptureBurn)
        {
            ...
            while (true)
            {
                ...
                FlightPlanPlugin.Logger.LogInfo($"CalcLambertDVs: departure at UT {FPUtility.SecondsToTimeString(utTransfer)}, exitDV = {exitDV:N3} = {exitDV.magnitude:N3} m/s");
                ...
                int thatWay = 0; // SDR was 2 on 2/11/2024
                ...
                FlightPlanPlugin.Logger.LogInfo($"CalcLambertDVs: position = {position.localPosition:N3} = {position.localPosition.magnitude:N3} m/s");
                FlightPlanPlugin.Logger.LogInfo($"CalcLambertDVs: velocity = {velocity.relativeVelocity.vector:N3} = {velocity.relativeVelocity.vector.magnitude:N3} m/s");
                ...
                FlightPlanPlugin.Logger.LogInfo($"CalcLambertDVs: vsoi = {vsoi:N3} = {vsoi.magnitude:N3} m/s");
                ...
                FlightPlanPlugin.Logger.LogInfo($"ComputeEjectionManeuver: maneuver.dV = {maneuver.dV:N3} = {maneuver.dV.magnitude:N3} m/s");
                ...
                FlightPlanPlugin.Logger.LogInfo($"burnVec: {burnVec:N3} = {burnVec.magnitude:N3}");
                ...
                maneuver.dV = burnVec;
                FlightPlanPlugin.Logger.LogInfo($"Updated maneuver.UT = {FPUtility.SecondsToTimeString(maneuver.UT)}, maneuver.dV = {maneuver.dV:N3} = {maneuver.dV.magnitude:N3} m/s");
