...
public class FlightPlanPlugin : BaseSpaceWarpPlugin
{
    ...
    [PublicAPI] public static FlightPlanPlugin Instance { get; set; }

    // AppBar button IDs
    internal const string ToolbarFlightButtonID = "BTN-FlightPlanFlight";
    internal const string ToolbarOabButtonID = "BTN-FlightPlanOAB";
    internal const string ToolbarKscButtonID = "BTN-FlightPlanKSC";
    ...
    public override void OnInitialized()
    {
        ...
        var windowOptions = new WindowOptions
        {
            ...
            WindowId = "FlightPlan_MyFirstWindow",
    ...
    private static void LoadAssemblies()
    {
        ...
        var unityAssembly = Assembly.LoadFrom(Path.Combine(currentFolder, "FlightPlan.Unity.dll"));
